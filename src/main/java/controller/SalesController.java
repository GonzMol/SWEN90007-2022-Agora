...
@WebServlet(name = "SalesController", value = "/sales")
public class SalesController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<Order> orders = OrderMapper.fetchWithSellerId(user.getId());
        if (orders != null) {
        ...
        request.setAttribute("heading", "All Sales");
        request.setAttribute("userRole", "seller");
